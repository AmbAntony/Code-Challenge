...
function beerDisplay(beer){
    ...
    // changing of our beer descriptions
    ...
    // removing place-holders for customer reviews
    ...
    // Updating beer Name, beer Image, beer description
    // displaying reviews to each specific beer
...
// extra practice -  create Beer name, description, image Url and its reviews
...
initializeFlataBeer()
 ...
 initializeFlataBeer()ument.getElementById('review-form');
 const beerReviewText = document.getElementById('review');
